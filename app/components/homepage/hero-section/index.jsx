        ...
        <div className="order-1 lg:order-2 bg-[#2F2F2F] border-[#1b2c68a0] relative rounded-lg">
          ...
          <code className="font-mono text-xs md:text-sm lg:text-base">
            ...
            <div>
              ...
              <span className="text-gray-400">'</span>
              <span className="text-amber-300">Tony James</span>
              <span className="text-gray-400">',</span>
            </div>
            ...
            <div className="ml-8 lg:ml-16 mr-2">
              ...
              <span className="text-gray-400">: [</span>
              <span className="text-amber-300">'C/C++', 'Java', 'Python', 'JavaScript'</span>
              <span className="text-gray-400">],</span>
            </div>
            <div className="ml-8 lg:ml-16 mr-2">
              <span className="text-white">frontend</span>
              <span className="text-gray-400">: [</span>
              <span className="text-amber-300">'Angular', 'React', 'Next.js' 'HTML/CSS'</span>
              <span className="text-gray-400">],</span>
            </div>
            <div className="ml-8 lg:ml-16 mr-2">
              <span className="text-white">backend</span>
              <span className="text-gray-400">: [</span>
              <span className="text-amber-300">'Spring Boot', 'Django', 'Express.js'</span>
              <span className="text-gray-400">],</span>
            </div>
            <div className="ml-8 lg:ml-16 mr-2">
              <span className="text-white">database</span>
              <span className="text-gray-400">: [</span>
              <span className="text-amber-300">'MySQL', 'DynamoDB', 'Redis', 'MongoDB'</span>
              <span className="text-gray-400">]</span>
            </div>
            <div className="ml-8 lg:ml-16 mr-2">
              <span className="text-white">DevOps</span>
              <span className="text-gray-400">: [</span>
              <span className="text-amber-300">'Docker', 'AWS', 'Kubernetes,', 'CI/CD'</span>
              <span className="text-gray-400">]</span>
            </div>
            <div>
